object FormUpdateTemplate: TFormUpdateTemplate
  ...
  object UniSPUpdateTemplate: TUniStoredProc
    ...
    SQL.Strings = (
        ...
        'CALL update_template(:p_template_id, :p_name, :p_job_opportunity' +
        ', :p_job_place, :p_phone_numbers_text, :p_template_introduction,' +
        ' :p_archived, :p_footer_1_header, :p_footer_1_text, :p_footer_2_' +
        'header, :p_footer_2_text, :p_footer_3_header, :p_footer_3_text, ' +
