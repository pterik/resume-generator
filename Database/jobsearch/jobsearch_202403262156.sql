...
-- Script date 26.03.2024 21:56:40
...
PROCEDURE update_resume (IN p_resume_id integer, IN p_name varchar(50), IN p_job_opportunity varchar(255), IN p_job_place varchar(255), IN p_phone_numbers_text varchar(512), IN p_resume_introduction text, IN p_archived integer, IN p_footer_1_header varchar(255), IN p_footer_1_text text, IN p_footer_2_header varchar(255), IN p_footer_2_text text, IN p_footer_3_header varchar(255), IN p_footer_3_text text, IN p_footer_4_header varchar(255), IN p_footer_4_text text, OUT p_result integer)
BEGIN
  SET p_result = 1;
...
CREATE
DEFINER = 'jobreport'@'localhost'
PROCEDURE update_template (IN p_template_id integer, IN p_name varchar(50), IN p_job_opportunity varchar(255), IN p_job_place varchar(255), IN p_phone_numbers_text varchar(255), IN p_template_introduction text, IN p_archived integer, IN p_footer_1_header varchar(255), IN p_footer_1_text varchar(2000), IN p_footer_2_header varchar(255), IN p_footer_2_text varchar(2000), IN p_footer_3_header varchar(255), IN p_footer_3_text varchar(2000), IN p_footer_4_header varchar(255), IN p_footer_4_text varchar(2000), OUT p_result integer)
BEGIN
  SET p_result = 1;
...
CREATE
DEFINER = 'jobreport'@'localhost'
PROCEDURE insert_experience (IN p_flag varchar(20), IN p_resume_id integer, IN p_template_id integer, IN p_job_order integer, IN p_job_position varchar(255), IN p_start_date datetime, IN p_end_date datetime, IN p_employer varchar(255), IN p_resp text, IN p_benefits varchar(1000), IN p_other text, OUT p_experience_id int)
BEGIN
...
--
CREATE
DEFINER = 'jobreport'@'127.0.0.1'
PROCEDURE insert_skill (IN p_skill varchar(255), IN p_category varchar(255), OUT p_skill_id int)
BEGIN
...
CREATE
DEFINER = 'jobreport'@'localhost'
PROCEDURE insert_template (IN p_name varchar(50), IN p_job_opportunity varchar(255), IN p_job_place varchar(255), IN p_phone_numbers_text varchar(255), IN p_template_introduction text, IN p_footer_1_header varchar(255), IN p_footer_1_text varchar(2000), IN p_footer_2_header varchar(255), IN p_footer_2_text varchar(2000), IN p_footer_3_header varchar(255), IN p_footer_3_text varchar(2000), IN p_footer_4_header varchar(255), IN p_footer_4_text varchar(2000), OUT p_template_id integer, OUT p_result integer)
BEGIN
  SET p_result = 1;
  SELECT
...
CREATE
DEFINER = 'jobreport'@'localhost'
PROCEDURE insert_skill_show (IN p_experience_id int, IN p_skill varchar(255))
BEGIN
  DECLARE l_skill_id integer;
  SELECT
    MAX(ID) INTO l_skill_id
...
CREATE
DEFINER = 'jobreport'@'localhost'
PROCEDURE insert_resume (IN p_name varchar(50), IN p_lang varchar(3), IN p_region_id varchar(2), IN p_job_opportunity varchar(255), IN p_job_place varchar(255), IN p_phone_numbers_text varchar(255), IN p_resume_introduction text, IN p_footer_1_header varchar(255), IN p_footer_1_text text, IN p_footer_2_header varchar(255), IN p_footer_2_text text, IN p_footer_3_header varchar(255), IN p_footer_3_text text, IN p_footer_4_header varchar(255), IN p_footer_4_text text, IN p_archived tinyint, INOUT p_resume_id integer)
BEGIN
  SELECT
...
CREATE
DEFINER = 'jobreport'@'localhost'
PROCEDURE delete_template_all (IN p_template_id int)
BEGIN
  DELETE
...
CREATE
DEFINER = 'jobreport'@'127.0.0.1'
PROCEDURE delete_skills (IN p_skill_id int)
BEGIN
  DELETE
    FROM skill_show_lists
...
CREATE
DEFINER = 'jobreport'@'localhost'
PROCEDURE delete_experiences_skills (IN p_flag varchar(50), IN p_template_id int, IN p_resume_id int)
BEGIN
  IF (p_flag = 'resume_id') THEN
    DELETE
      FROM skill_show_lists l
...
(310, 98, 'Мови', 'Поглиблений рівень англійської мови. Носій української та російської мов. \r\nСередній рівень німецької, польської мов.', 1, '2024-03-25 20:52:19', '2024-03-25 20:52:19'),
(311, 98, 'Курси навчання', 'Oracle 11 DBA (database administrator), Informatica Power Center', 3, '2024-03-25 20:52:19', '2024-03-25 20:52:19');
...
(116, 321, '2024-03-20 02:03:26', '2024-03-20 02:03:26'),
(117, 321, '2024-03-20 02:03:26', '2024-03-20 02:03:26'),
(122, 321, '2024-03-20 02:03:26', '2024-03-20 02:03:26'),
(123, 343, '2024-03-22 01:13:49', '2024-03-22 01:13:49'),
...
(139, 82, 'Technische Fahigkeiten und Technologie', '1', 1, '2024-03-20 02:03:26', '2024-03-20 02:03:26'),
(140, 82, 'Technische 2 Fahigkeiten und Technologie', '1', 2, '2024-03-20 02:03:26', '2024-03-20 02:03:26'),
(141, 82, 'Technische 3 Fahigkeiten und Technologie', '3', 3, '2024-03-20 02:03:26', '2024-03-20 02:03:26'),
(142, 82, 'Technische 4 Fahigkeiten und Technologie', '4', 4, '2024-03-20 02:03:26', '2024-03-20 02:03:26'),
(146, 85, 'Технічні навички та технології', 'Linux Systems (Red hat & Ubuntu) - 6 років\r\nMS Azure – 3 роки\r\nDevelopment for Oracle databases, Microsoft SQL server - 7 років\r\nSQL queries - 10 років\r\nReports and dashboards – 5 років\r\nPHP – 2 роки\r\nJava – 2 роки\r\nPython – 1 рік', 1, '2024-03-20 12:47:23', '2024-03-20 12:47:23'),
(147, 85, 'Мови', 'Поглиблений рівень англійської мови. Носій української та російської мов. \r\nСередній рівень німецької, польської мов.', 2, '2024-03-20 12:47:23', '2024-03-20 12:47:23'),
(148, 85, 'Курси навчання', 'Oracle 11 DBA (database administrator), Informatica Power Center', 3, '2024-03-20 12:47:23', '2024-03-20 12:47:23'),
(182, 86, 'Технічні навички та технології', 'Linux Systems (Red hat & Ubuntu) - 6 років\r\nMS Azure – 3 роки\r\nDevelopment for Oracle databases, Microsoft SQL server - 7 років\r\nSQL queries - 10 років\r\nReports and dashboards – 5 років\r\nPHP – 2 роки\r\nJava – 2 роки\r\nPython – 1 рік', 1, '2024-03-22 01:13:49', '2024-03-22 01:13:49'),
(183, 86, 'Мови', 'Поглиблений рівень англійської мови. Носій української та російської мов. \r\nСередній рівень німецької, польської мов', 2, '2024-03-22 01:13:49', '2024-03-22 01:13:49'),
(184, 86, 'Курси навчання', 'Oracle 11 DBA (database administrator), Informatica Power Center', 3, '2024-03-22 01:13:49', '2024-03-22 01:13:49'),
...
(10, 'main_folder', 'h:\\Мой диск\\Поиск работы'),
(11, 'main_folder_VESTA', 'h:\\Мой диск\\Поиск работы'),
...
-- Table jobsearch.activity_tasks does not contain any data (it is empty)
