...
-- Script date 19.03.2024 13:49:03
...
CREATE TABLE resumes (
  ...
  resume_introduction64 blob DEFAULT NULL,
...
CREATE TABLE resume_footers (
  ...
  footer_text64 blob DEFAULT NULL,
...
PROCEDURE update_resume (IN p_resume_id integer, IN p_name varchar(50), IN p_job_opportunity varchar(255), IN p_job_place varchar(255), IN p_phone_numbers_text varchar(512), IN p_resume_introduction text, IN p_archived integer, IN p_footer_1_header varchar(255), IN p_footer_1_text varchar(1000), IN p_footer_2_header varchar(255), IN p_footer_2_text varchar(1000), IN p_footer_3_header varchar(255), IN p_footer_3_text varchar(1000), IN p_footer_4_header varchar(255), IN p_footer_4_text varchar(1000), OUT p_result integer)
BEGIN
  SET p_result = 1;
  ...
  SET name = p_name,
      ...
      resume_introduction64 = TO_BASE64(p_resume_introduction),
      archived = p_archived
  ...
  IF LENGTH(TRIM(p_footer_1_header)) + LENGTH(TRIM(p_footer_1_text)) > 0 THEN
    INSERT INTO resume_footers (resume_id, footer_header, footer_text, footer_order)
      VALUES (p_resume_id, p_footer_1_header, TO_BASE64(p_footer_1_text), 1);
  END IF;
  IF LENGTH(TRIM(p_footer_2_header)) + LENGTH(TRIM(p_footer_2_text)) > 0 THEN
    INSERT INTO resume_footers (resume_id, footer_header, footer_text, footer_order)
      VALUES (p_resume_id, p_footer_2_header, TO_BASE64(p_footer_2_text), 2);
  END IF;

  IF LENGTH(TRIM(p_footer_3_header)) + LENGTH(TRIM(p_footer_3_text)) > 0 THEN
    INSERT INTO resume_footers (resume_id, footer_header, footer_text, footer_order)
      VALUES (p_resume_id, p_footer_3_header, TO_BASE64(p_footer_3_text), 3);
  END IF;

  IF LENGTH(TRIM(p_footer_4_header)) + LENGTH(TRIM(p_footer_4_text)) > 0 THEN
    INSERT INTO resume_footers (resume_id, footer_header, footer_text, footer_order)
      VALUES (p_resume_id, p_footer_4_header, TO_BASE64(p_footer_4_text), 4);
  END IF;
  SET p_result = 0;
END
$$
...
CREATE
DEFINER = 'jobreport'@'localhost'
PROCEDURE insert_experience (IN p_flag varchar(20), IN p_resume_id integer, IN p_template_id integer, IN p_job_order integer, IN p_job_position varchar(255), IN p_start_date datetime, IN p_end_date datetime, IN p_employer varchar(255), IN p_resp text, IN p_benefits varchar(1000), IN p_leave_reason varchar(1000), OUT p_experience_id int)
BEGIN
  IF (p_flag = 'resume_id') THEN
    INSERT INTO experiences (resume_id, template_id, job_order, job_position, start_date, end_date, employer, responsibilities, benefits, leave_reason)
      VALUES (p_resume_id, NULL, p_job_order, p_job_position, p_start_date, p_end_date, p_employer, p_resp, p_benefits, p_leave_reason);
    SET p_experience_id = LAST_INSERT_ID();
  END IF;

  IF (p_flag = 'template_id') THEN
    INSERT INTO experiences (resume_id, template_id, job_order, job_position, start_date, end_date, employer, responsibilities, benefits, leave_reason)
      VALUES (NULL, p_template_id, p_job_order, p_job_position, p_start_date, p_end_date, p_employer, p_resp, p_benefits, p_leave_reason);
    SET p_experience_id = LAST_INSERT_ID();
  END IF;
...
CREATE
DEFINER = 'jobreport'@'localhost'
PROCEDURE insert_resume (IN p_name varchar(50), IN p_lang varchar(3), IN p_region_id varchar(2), IN p_job_opportunity varchar(255), IN p_job_place varchar(255), IN p_phone_numbers_text varchar(255), IN p_resume_introduction varchar(1000), IN p_footer_1_header varchar(255), IN p_footer_1_text varchar(1000), IN p_footer_2_header varchar(255), IN p_footer_2_text varchar(1000), IN p_footer_3_header varchar(255), IN p_footer_3_text varchar(1000), IN p_footer_4_header varchar(255), IN p_footer_4_text varchar(1000), IN p_archived tinyint(1), INOUT p_resume_id integer)
BEGIN
  SELECT
  ...
  DELETE
    FROM resumes
  WHERE id = p_resume_id;
  INSERT INTO resumes (name, lang, region_id, job_opportunity, job_place, phone_numbers_text, resume_introduction, resume_introduction64, archived)
    VALUES (p_name, p_lang, p_region_id, p_job_opportunity, p_job_place, p_phone_numbers_text, p_resume_introduction, TO_BASE64(p_resume_introduction), p_archived);
  SELECT
    LAST_INSERT_ID() INTO p_resume_id;
  IF NOT (IFNULL(p_footer_1_header, '') = ''
    AND IFNULL(p_footer_1_text, '') = '') THEN
    INSERT INTO resume_footers (resume_id, footer_header, footer_text, footer_text64, footer_order)
      VALUES (p_resume_id, p_footer_1_header, p_footer_1_text, TO_BASE64(p_footer_1_text), 1);
  END IF;
  IF NOT (IFNULL(p_footer_2_header, '') = ''
    AND IFNULL(p_footer_2_text, '') = '') THEN
    INSERT INTO resume_footers (resume_id, footer_header, footer_text, footer_text64, footer_order)
      VALUES (p_resume_id, p_footer_2_header, p_footer_2_text, TO_BASE64(p_footer_2_text), 2);
  END IF;
  IF NOT (IFNULL(p_footer_3_header, '') = ''
    AND IFNULL(p_footer_3_text, '') = '') THEN
    INSERT INTO resume_footers (resume_id, footer_header, footer_text, footer_text64, footer_order)
      VALUES (p_resume_id, p_footer_3_header, p_footer_3_text, TO_BASE64(p_footer_3_text), 3);
  END IF;
  IF NOT (IFNULL(p_footer_4_header, '') = ''
    AND IFNULL(p_footer_4_text, '') = '') THEN
    INSERT INTO resume_footers (resume_id, footer_header, footer_text, footer_order)
      VALUES (p_resume_id, p_footer_4_header, p_footer_4_text, TO_BASE64(p_footer_4_text), 4);
  END IF;
END
$$
...
(76, 'Test4', 'UA', 'UA', '33', '33', '33', NULL, NULL, '76', NULL, 0, '2024-03-05 01:15:46', '2024-03-17 18:01:08'),
(80, 'Test3', 'UA', 'UA', '5', '5', '5', NULL, NULL, '80', NULL, 0, '2024-03-05 01:23:01', '2024-03-17 18:01:08'),
(81, 'Test2', 'UA', 'UA', '8', '8', 'Бла бла бла', NULL, NULL, '1234567890\r\nБла бла бла', x'4D54497A4E4455324E7A67354D41304B304A485175394377494E4378304C76517343445173644337304C413D', 0, '2024-03-05 01:27:40', '2024-03-17 19:05:42'),
(82, 'Oracle-Entwickler', 'DE', 'DE', 'Oracle-Entwickler', 'Fernarbeit', '+(385) 998 511 378', NULL, NULL, 'dfdfd df dfd fdf df df df df df dfdfd df dfd fdf df df df df df dfdfd df dfd fdf df df df df df dfdfd df dfd fdf df df df df df dfdfd df dfd fdf df df df df df dfdfd df dfd fdf df df df df df dfdfd df dfd fdf df df df df df dfdfd df dfd fdf df df df df df dfdfd df Recommendation letter: \r\nhttps://t.me/Data_migration_club\r\nRecommendation letter: https://bit.ly/3ITcypl', x'', 0, '2024-03-06 22:50:59', '2024-03-17 20:19:36'),
(83, 'Test1', 'DE', 'DE', '1', '1', '1', NULL, NULL, '83', NULL, 0, '2024-03-07 02:09:08', '2024-03-17 18:01:08'),
(84, 'Тесто2', 'UA', 'UA', 'Тесто2 повністю', 'Віддалено', 'Такий номер', NULL, NULL, '84', x'4F44513D', 0, '2024-03-15 21:41:45', '2024-03-17 19:55:56');

-- 
-- Dumping data for table templates
--
INSERT INTO templates VALUES
(90, 'bideveloper', 'BI розробник або DBA інженер', 'Віддалена', '+(380) 93 177 51 76 Viber, Whatsapp', 'Зверніть будь ласка увагу на мій загальний досвід 10 років у розробці, впровадженні та тех-нічну підтримку у фінансовій, страховій та банківській сферах. За цей час я отримав експертні знан-ня у галузі розробки програмного забезпечення.\r\nЯ працюю як програміст більше 10 років, та маю декілька проектів на GitHub для демонстра-ції. Я займаюся базами даних: Microsoft SQL Server і Oracle використовувати їх як великі сховища (DWH). Основне завдання в таких сховищах – створення аналітичних звітів (BI Reports), а також оптимізація їх роботи. Основні технології такої роботи – це Microsoft Power BI (SSRS), JasperReports. Також я створював звіти за допомогою Oracle Reports, Crystal Reports\r\nШість років тому я працював на технічну підтримку JasperSoft (програма JasperReports) і на-вчився створювати звіти на основі вимог користувачів. До моїх обов''язків входило усунення про-блем, пов''язаних зі звітами, та своєчасна відповідь на звернення користувачів. У багатьох проектах команда розробки знаходиться далеко від інших команд, іноді на іншому континенті. То ж мені до-водилося співпрацювати з людьми з різних країн світу для підтримки прийнятих рішень. Під час ро-боти ми дотримувалися встановлених стандартів та рекомендацій щодо організації технічної підтри-мки згідно вимог ITIL.\r\nЯ закінчив Харківський державний університет, фізичний факультет. Навчання фізикою та математикою допомогли мені розвинути сильні аналітичні здібності та вміння помічати деталі, кон-центруючись на отриманні зрозумілих результатів.\r\nПрацюючи як програміст більше 10 років, я підвищив рівень знання англійської мови до рівня B2, маю підтвердження цієї оцінки. Пройшов English Benchmark test з відміткою 6 балів, посилання в кінці документу.', 0, '2024-03-19 12:25:37', '2024-03-19 12:25:37');
...
(246, 76, NULL, 1, '4', '2020-01-01', '2021-01-01', '4', '4', '4', '', '2024-03-17 01:07:36', '2024-03-17 01:07:36'),
(247, 80, NULL, 1, '3', '2020-01-01', '2020-12-31', '3', '3', '3', '', '2024-03-17 01:07:41', '2024-03-17 01:07:41'),
(250, 83, NULL, 1, '1', '2020-01-29', '2024-03-06', '1', '1', '1', '', '2024-03-17 01:07:49', '2024-03-17 01:07:49'),
(260, 81, NULL, 1, '8', '2020-01-01', '2020-12-31', '8', '8', '', '', '2024-03-17 19:05:42', '2024-03-17 19:05:42'),
(261, 81, NULL, 2, '9', '2020-06-10', '2024-03-05', '9', '9', '', '', '2024-03-17 19:05:42', '2024-03-17 19:05:42'),
(268, 84, NULL, 1, 'Інженер', '2023-06-01', '2024-03-01', 'Компанія', 'Обовязки', 'Вигода 1', '', '2024-03-17 19:55:56', '2024-03-17 19:55:56'),
(278, 82, NULL, 1, 'Entwickler', '2022-09-01', '2024-03-06', 'Studio „AVEX“', 'Verantwortlichkeiten: \r\nIch suche einmalige Aufgaben auf Freelance-Borsen. Dabei handelt es sich um die Erstellung und Anderung von Webseiten in PHP, Python sowie die Erstellung automatischer Skripte fur tagliche Aufgaben', '', '', '2024-03-17 20:19:36', '2024-03-17 20:19:36'),
(279, 82, NULL, 2, 'Senior Entwickler (Fernarbeit)', '2021-10-01', '2022-10-01', 'Codegenix- Unternehmen (USA, Texas). Outsourcer fur ein Unternehmen GlueUp.', 'Verantwortlichkeiten: \r\nMehrere heterogene Unternehmensdatenbanken sind standig im Einsatz (Oracle, MySQL, MongoDB). Um Analyse- und Finanzberichte zu erstellen, war es notwendig, eine neue DWH-Datenbank zu erstellen und mehrere Arbeitsablaufe zu erstellen, um die Daten kontinuierlich in den Archivspeicher zu ubertragen.\r\nMeine Aufgabe bestand darin, Arbeitsablaufe zu erstellen und umzusetzen. Einige Workflows wurden mit ETL Talend sowie mit Python-Skripten und einem Delphi-Programm erstellt. Nach mehreren Monaten der Implementierung wurden Arbeitsablaufe erstellt und getestet. Sie erfullen alle Anforderungen und die Fuhrungskrafte waren mit der geleisteten Arbeit zufrieden.\r\n', '', 'Empfehlungsschreiben: https://www.data-migration.club/r/letter-of-recommendation.pdf ', '2024-03-17 20:19:36', '2024-03-17 20:19:36'),
(280, 82, NULL, 3, 'Entwickler (Fernarbeit)', '2019-04-01', '2020-03-01', 'Emergn-Unternehmen (Ukraine). Outsourcing fur Mercer (USA)', 'Verantwortlichkeiten:\r\nKunde des Projekts war die Versicherungsgesellschaft Mercer, USA. Emergn ist ein in der Ukraine tatiges Beratungsunternehmen. Meine Aufgaben im Projekt sind Datenbankentwickler. Ziel des Projekts sind tagliche Datenworkflows von der Oracle Premise- Datenbank bis zur Azure- Cloud. Dies ist die DWH-Datenbank und die Analyseberichte wurden darauf ausgefuhrt. Talend- Workflows wurden zum Ubertragen von Daten und zum Erstellen von Berichten verwendet. In der Anfangsphase gab es bei SQL-Abfragen Probleme mit geringer SQL-Performance, diese konnten erfolgreich behoben werden.\r\n', '', '', '2024-03-17 20:19:36', '2024-03-17 20:19:36'),
(304, NULL, 90, 1, 'Senior developer (віддалена)', '2021-10-01', '2022-08-03', 'Компанія Codegenix (USA, Texas). Аутсорсер для компанії GlueUp', 'Обов''язки: \r\nКілька неоднорідних баз даних компанії є у виробництві (Oracle, MySQL, MongoDB). Для створення аналітичних та фінансових звітів необхідно розширити базу даних DWH та створити кілька робочих процесів для постійної передачі даних на зберігання DWH.\r\nМоя відповідальність полягала в створенні та впровадженні робочих процесів ETL. Деякі робочі процеси були створені за допомогою ETL Talend, а також з використанням сценаріїв Python, з використанням Delphi. Після декількох місяців впровадження робочі процеси були створені та протестовані. Вони виконують усі вимоги, а керівники залишилися задоволені виконаною роботою.\r\n', 'Рекомендаційний лист: https://www.data-migration.club/r/letter.pdf', 'Причина звільнення: війна в Україні.', '2024-03-19 12:30:57', '2024-03-19 12:30:57'),
(305, NULL, 90, 2, 'BI developer (віддалена)', '2019-04-03', '2020-03-05', 'Компанія Emergn (Ukraine).  Аутсорсінг для компанії Mercer (USA)', 'Обов''язки: \r\nЗамовником проекту була страхова компанія Mercer, США. Emergn – це консалтингова компанія, що працює в Україні. Мої обов''язки в проекті - розробник баз даних. Метою проекту є щоденні робочі процеси даних із бази даних Oracle Premise до хмари Azure, бази даних Microsoft SQL. Це база даних  DWH, і в ній запускалися аналітичні звіти (BI Reports) на сервері Power BI Server. Робочі процеси Talend використовувалися для передачі даних і створення звітів. На початкових етапах звіти виконувались повільно, та SQL-запити мали проблеми з продуктивністю. Проблеми були успішно усунуті, швидкість виконання збільшилась на 2-10 разів.\r\n', '', '', '2024-03-19 12:30:57', '2024-03-19 12:30:57'),
(306, NULL, 90, 3, 'Engineer (віддалена)', '2018-01-03', '2019-02-06', 'Компанія Jaspersoft (підрозділ Tibco USA)', 'Технічна підтримка додатків Jaspersoft - JasperReport Server і ETL Talend Studio. Сервери Jaspersoft можуть працювати з різними базами даних з джерелами даних з різних баз даних - Postgres, Oracle, MS SQL і MySQL. Я відповідаю за те, щоб допомагати користувачам встановлювати та налаштовувати додатоки JasperReports, а також допомагати знаходити та виправляти виявлені помилки.', 'Ці програми працюють на всіх платформах (Windows, Unix, MacOS) і з різними базами даних. Я отримав практичний досвід роботи з різними ОС, а також з різноманітними реляційними базами даних.', '', '2024-03-19 12:30:57', '2024-03-19 12:30:57');
...
(276, 90, 'Технічні навички та технології', 'Power BI – 2 роки\r\nDevelopment for Oracle databases - 7 років\r\nFor Microsoft SQL server – 5 років\r\nSQL queries - 10 років\r\nReports and dashboards – 5 років\r\nMS Azure – 3 роки\r\nLinux Systems (Red hat & Ubuntu) - 6 років', 1, '2024-03-19 12:30:57', '2024-03-19 12:30:57'),
(277, 90, 'Мови', 'Поглиблений рівень англійської мови. Носій української та російської мов. \r\nСередній рівень німецької, польської мов.', 2, '2024-03-19 12:30:57', '2024-03-19 12:30:57'),
(278, 90, 'Курси навчання', 'Oracle 11 DBA (database administrator), Informatica Power Center', 3, '2024-03-19 12:30:57', '2024-03-19 12:30:57'),
(279, 90, 'Засоби зв’язку зі мною', 'Я часто буваю онлайн, і віддаю перевагу зустрічам з веб-камерою, живим спілкуванням.\r\nДуже прошу Вас надсилати запрошення електронною поштою. Для швидкого спілкування та коротких питань телефонуйте +38093 177 5176. Резервний номер +380687024241.', 4, '2024-03-19 12:30:57', '2024-03-19 12:30:57');
...
(10, 304, '2024-03-19 12:30:57', '2024-03-19 12:30:57'),
(111, 304, '2024-03-19 12:30:57', '2024-03-19 12:30:57'),
(112, 304, '2024-03-19 12:30:57', '2024-03-19 12:30:57'),
(113, 305, '2024-03-19 12:30:57', '2024-03-19 12:30:57'),
(114, 306, '2024-03-19 12:30:57', '2024-03-19 12:30:57'),
(115, 306, '2024-03-19 12:30:57', '2024-03-19 12:30:57');

-- 
-- Dumping data for table resume_footers
--
INSERT INTO resume_footers VALUES
(93, 76, '33', '', NULL, 1, '2024-03-17 01:07:36', '2024-03-17 01:07:36'),
(94, 80, '5', '', NULL, 1, '2024-03-17 01:07:41', '2024-03-17 01:07:41'),
(96, 83, '1', '', NULL, 1, '2024-03-17 01:07:49', '2024-03-17 01:07:49'),
(100, 81, '8', '', NULL, 1, '2024-03-17 19:05:42', '2024-03-17 19:05:42'),
(103, 84, 'Навик 1', '', NULL, 1, '2024-03-17 19:55:56', '2024-03-17 19:55:56'),
(107, 82, 'Technische Fahigkeiten und Technologie', '', NULL, 1, '2024-03-17 20:19:36', '2024-03-18 15:34:52');
