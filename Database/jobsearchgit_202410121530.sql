...
-- Script date 12.10.2024 15:30:39
...
BEGIN
  ...
  IF LENGTH(TRIM(p_footer_1_header)) + LENGTH(TRIM(p_footer_1_text)) > 0 THEN
    INSERT INTO resume_footers (resume_id, footer_header, footer_text, footer_order)
      VALUES (p_resume_id, p_footer_1_header, p_footer_1_text, 1);
  END IF;
  IF LENGTH(TRIM(p_footer_2_header)) + LENGTH(TRIM(p_footer_2_text)) > 0 THEN
    INSERT INTO resume_footers (resume_id, footer_header, footer_text, footer_order)
      VALUES (p_resume_id, p_footer_2_header, p_footer_2_text, 2);
  END IF;

  IF LENGTH(TRIM(p_footer_3_header)) + LENGTH(TRIM(p_footer_3_text)) > 0 THEN
    INSERT INTO resume_footers (resume_id, footer_header, footer_text, footer_order)
      VALUES (p_resume_id, p_footer_3_header, p_footer_3_text, 3);
  END IF;

  IF LENGTH(TRIM(p_footer_4_header)) + LENGTH(TRIM(p_footer_4_text)) > 0 THEN
    INSERT INTO resume_footers (resume_id, footer_header, footer_text, footer_order)
      VALUES (p_resume_id, p_footer_4_header, p_footer_4_text, 4);
  END IF;
  SET p_result = 0;
END
$$
...
(361, 87, NULL, 1, 'Developer (remote) ', '2022-09-14', '2024-03-25', 'Avex ', 'Tvrtka izraduje web stranice i razvija web servise za generiranje izvjesca. Radio sam s MySQL bazom kao administrator i programer. Napravio sam skripte za automatsko preuzimanje podataka i generiranje mreznih izvjesca. Delphi programi i Python skripte koristeni su za svakodnevne zadatke.', '', '', '2024-03-25 23:34:21', '2024-03-25 23:34:21'),
(362, 87, NULL, 2, 'Senior developer (rad na daljinu) ', '2020-10-21', '2022-08-18', 'Tvrtka Codegenix (SAD, Texas). Outsourcer za GlueUp', 'Nekoliko heterogenih baza podataka tvrtke je u produkciji (Oracle, MySQL, MongoDB). Za izradu analitickih i financijskih izvjesca potrebno je prosiriti DWH bazu podataka i kreirati nekoliko radnih procesa za kontinuirani prijenos podataka u DWH pohranu.\r\nMoja je odgovornost bila stvoriti i implementirati ETL tijekove rada. Neki tijekovi rada stvoreni su koristenjem Talendovog ETL-a kao i koristenjem Python skripti. Nakon nekoliko mjeseci implementacije, izradeni su i testirani tijek rada. Zadovoljavaju sve potrebne uvjete, a voditelji su bili zadovoljni obavljenim poslom.', 'Iskustvo s NoSQL bazama podataka (MongoDB, JSON структури)', 'Preporuka: <a>https://www.data-migration.club/cv/letter-of-recommendation.pdf</a>', '2024-03-25 23:34:21', '2024-03-25 23:34:21'),
(363, 87, NULL, 3, 'Developer (rad na daljinu)', '2019-04-10', '2020-03-04', 'Tvrtka Emergn (Ukrajina). Outsourcing za Mercer (SAD)', 'Narucitelj projekta bila je osiguravajuca kuca Mercer, SAD. Emergn je konzultantska tvrtka koja djeluje u Ukrajini. Moje duznosti u projektu su razvoj baze podataka. Cilj projekta su dnevni tokovi podataka iz Oracle Premise baze podataka u Azure cloud, Microsoft SQL bazu podataka. Ovo je DWH baza podataka i na njoj su pokrenuta analiticka izvjesca. Za prijenos podataka i generiranje izvjesca koristeni su tijekovi rada Talenda. U pocetnim su fazama SQL upiti imali problema s niskim performansama SQL-a, koji su uspjesno eliminirani.\r\n', '', '', '2024-03-25 23:34:21', '2024-03-25 23:34:21'),
(364, 87, NULL, 4, 'Engineer (rad na daljinu)', '2016-01-01', '2018-02-07', 'Jaspersoft (odjel tvrtke Tibco USA)', 'Tehnicka podrska za Jaspersoft Java aplikacije - JasperReport Server i ETL Talend Studio. Jaspersoft posluzitelji mogu raditi s razlicitim bazama podataka s izvorima podataka iz razlicitih baza podataka - Postgres, Oracle, MS SQL i MySQL. Odgovoran sam za pomoc korisnicima pri instaliranju i konfiguriranju Jaspersoft & i Talend Java aplikacija, kao i za pomoc u pronalazenju i ispravljanju gresaka.\r\n', 'Tehnicka podrska za Jaspersoft Java aplikacije - JasperReport Server i ETL Talend Studio. Jaspersoft posluzitelji mogu raditi s razlicitim bazama podataka s izvorima podataka iz razlicitih baza podataka - Postgres, Oracle, MS SQL i MySQL. Odgovoran sam za pomoc korisnicima pri instaliranju i konfiguriranju Jaspersoft & i Talend Java aplikacija, kao i za pomoc u pronalazenju i ispravljanju gresaka.', '', '2024-03-25 23:34:21', '2024-03-25 23:34:21'),
(365, 87, NULL, 5, 'Developer', '2013-05-01', '2015-04-01', 'Компанія Miratech (Poland)', 'Розробка робочих процесів ETL для Lindorff (Швеція). Проект міграції даних для міграції з Oracle DWH на Microsoft SQL. Мої обов’язки полягали в аналізі найновіших вимог, створенні вихідного коду та розгортанні його на сервері Microsoft SQL. Робочі процеси даних оброблялися за допомогою Informatica Power Center.\r\n', '', '', '2024-03-25 23:34:21', '2024-03-25 23:34:21'),
(366, 87, NULL, 6, 'Database developer', '2011-05-03', '2012-03-08', 'Компанія Luxoft (Ukraine). Технічна підтримка для європейського банку', 'Я був розробником групи підтримки ІТ. Ми забезпечували підтримку величезного Oracle DWH в інвестиційному банку. Вихідні коди були написані на Java та PL/SQL, а робочі процеси даних використовують Informatica PC. Наша команда підтримувала щоденні прогони робочих процесів, ми також підтримували формування звітів для зовнішнього банківського аудиту. Програмне забезпечення в банках має бути без помилок і збоїв, тому весь програмний код перевірявся кілька разів, включаючи автоматичні тести QA.\r\nЯ працював у великій команді з кількох країн, і координував роботу нашої команди з іншими відділами, ми використовували ServiceNow у своїй щоденній роботі. З моєї ініціативи було запроваджено сайт Jira для покращення комунікації, я отримав заохочувальний бонус за впровадження системи JIRA.', '', '', '2024-03-25 23:34:21', '2024-03-25 23:34:21'),
(368, 82, NULL, 1, '11111111111111111', '2024-02-27', '2024-03-05', '11111111111111', '111111111111111', '111111111', '111111111111', '2024-10-09 21:01:28', '2024-10-09 21:01:28'),
(372, 86, NULL, 1, 'Developer', '2018-06-06', '2018-10-24', 'Travel USA hobbit', 'Текст\r\n<a>http://website.com</a>\r\nемейл <a>astra@gmail.com</a>\r\nАле це не точно\r\n', '', '', '2024-10-09 22:18:31', '2024-10-09 22:18:31'),
(400, 85, NULL, 1, 'Developer & DBA', '2022-09-07', '2024-08-21', 'Avex', 'Компанія розробляє веб-сайти та веб-сервіси для формування звітів. Я працював з базою даних MySQL як адміністратор і програміст. Я створив сценарії для автоматичного завантаження даних, а також створення онлайн-звітів. Для повсякденних завдань використовувалися програми Delphi та скрипти Python.\r\n', '', '', '2024-10-10 22:53:22', '2024-10-10 22:53:22'),
(401, 85, NULL, 2, 'Senior developer', '2021-10-13', '2022-08-09', 'Codegenix (USA, Texas). Аутсорсер для компанії GlueUp', ' Кілька неоднорідних баз даних компанії є у виробництві (Oracle, MySQL, MongoDB). Для створення аналітичних та фінансових звітів необхідно розширити базу даних DWH та створити кілька робочих\r\nпроцесів для постійної передачі даних на зберігання DWH. Моя відповідальність полягала в створенні та впровадженні робочих процесів ETL. Деякі робочі процеси були створені за допомогою ETL Talend, а також використання сценаріїв Python. Після декількох місяців впровадження робочі процеси були створені та протестовані. Вони виконують усі необхідні вимоги, а керівники залишилися задоволені виконаною роботою.', 'Досвід роботи з базами даних NoSQL (MongoDB, JSON структури)', 'Рекомендаційний лист: https://www.data-migration.club/cv/letter-of-recommendation.pdf', '2024-10-10 22:53:22', '2024-10-10 22:53:22'),
(402, 85, NULL, 3, 'Developer', '2019-04-10', '2021-03-10', 'Emergn (Ukraine). Аутсорсінг для компанії Mercer (USA)', 'Замовником проекту була страхова компанія Mercer, США. Emergn – це консалтингова компанія, що працює в Україні. Мої обов''язки в проекті - розробник баз даних. Метою проекту є щоденні робочі процеси даних із бази даних Oracle Premise до хмари Azure, бази даних Microsoft SQL. Це база даних DWH, і в ній запускалися аналітичні звіти. Робочі процеси Talend використовувалися для передачі даних і створення звітів. На початкових етапах SQL-запити мали проблеми з низькою продуктивністю SQL, їх успішно усунули.', '', '', '2024-10-10 22:53:22', '2024-10-10 22:53:22'),
(403, 85, NULL, 4, 'Developer', '2018-05-08', '2019-01-23', 'Mede Analytics (Ukraine)', ' Компанія Mede-Analytics розробляє програмне забезпечення для виплат медичного страхування США. Клієнтами компанії є MEDICARE, MEDICAID, близько 200 компаній США. Документи\r\nмедичного страхування проходять повний фінансовий потік: завантаження, перевірка, зберігання в системі зберігання, відображення фінансових документів та інших звітів на веб-сайтах. Робочі процеси базуються на технології MS SQL, SSIS , OLAP Cube (MDX). Як розробник у групі впровадження я займався підтримкою бази даних. Я створив нові таблиці та процедури на основі надісланих технічних специфікацій. Для виконання завдання необхідно було вести електронне листування зі співробітниками в Америці та Європі, а також уточнювати деталі з менеджерами. Я також перевірив, чи нові структури створені на промисловий базі без помилок, і мені повідомляли про будь-які помилки, виявлені під час тестувань.', '', '', '2024-10-10 22:53:22', '2024-10-10 22:53:22'),
(404, 85, NULL, 5, 'Engineer', '2016-01-06', '2018-02-07', 'Jaspersoft (підрозділ Tibco USA)', 'Технічна підтримка додатків Jaspersoft Java - JasperReport Server і ETL Talend Studio. Сервери Jaspersoft можуть працювати з різними базами даних з джерелами даних з різних баз даних - Postgres, Oracle, MS SQL і MySQL. Я відповідаю за те, щоб допомагати користувачам встановлювати та налаштовувати Java-додатки Jaspersoft & і Talend, а також допомагати знаходити та виправляти виявлені помилки.', 'Ці програми Java працюють на всіх платформах (Windows, Unix, MacOS) і з різними базами', '', '2024-10-10 22:53:22', '2024-10-10 22:53:22'),
(405, 85, NULL, 6, 'Developer', '2013-05-08', '2015-04-08', 'Miratech (Poland)', ' Розробка робочих процесів ETL для Lindorff (Швеція). Проект міграції даних для міграції з Oracle DWH на Microsoft SQL. Мої обов’язки полягали в аналізі найновіших вимог, створенні вихідного коду та розгортанні його на сервері Microsoft SQL. Робочі процеси даних оброблялися за допомогою Informatica Power Center.', '', '', '2024-10-10 22:53:22', '2024-10-10 22:53:22'),
(406, 85, NULL, 7, 'Support Engineer', '2011-05-03', '2012-03-07', 'Luxoft (Ukraine). Технічна підтримка для європейського банку', ' Я був розробником групи підтримки ІТ. Ми забезпечували підтримку величезного Oracle DWH в інвестиційному банку. Вихідні коди були написані на Java та PL/SQL, а робочі процеси даних використовують Informatica PC. Наша команда підтримувала щоденні прогони робочих процесів, ми також підтримували формування звітів для зовнішнього банківського аудиту. Програмне забезпечення в банках має бути без помилок і збоїв, тому весь програмний код перевірявся кілька разів, включаючи автоматичні тести QA.\r\nЯ працював у великій команді з кількох країн, і координував роботу нашої команди з іншими відділами, ми використовували ServiceNow у своїй щоденній роботі. З моєї ініціативи було запроваджено сайт Jira для покращення комунікації, я отримав заохочувальний бонус за впровадження системи JIRA.', '', '', '2024-10-10 22:53:22', '2024-10-10 22:53:22');
...
(1, 401, '2024-10-10 22:53:22', '2024-10-10 22:53:22'),
(2, 400, '2024-10-10 22:53:22', '2024-10-10 22:53:22'),
(2, 401, '2024-10-10 22:53:22', '2024-10-10 22:53:22'),
(2, 406, '2024-10-10 22:53:22', '2024-10-10 22:53:22'),
(3, 401, '2024-10-10 22:53:22', '2024-10-10 22:53:22'),
(3, 406, '2024-10-10 22:53:22', '2024-10-10 22:53:22'),
(4, 401, '2024-10-10 22:53:22', '2024-10-10 22:53:22'),
(7, 402, '2024-10-10 22:53:22', '2024-10-10 22:53:22'),
(10, 350, '2024-03-25 20:52:19', '2024-03-25 20:52:19'),
(11, 402, '2024-10-10 22:53:22', '2024-10-10 22:53:22'),
(11, 403, '2024-10-10 22:53:22', '2024-10-10 22:53:22'),
(12, 402, '2024-10-10 22:53:22', '2024-10-10 22:53:22'),
(12, 403, '2024-10-10 22:53:22', '2024-10-10 22:53:22'),
(13, 402, '2024-10-10 22:53:22', '2024-10-10 22:53:22'),
(13, 404, '2024-10-10 22:53:22', '2024-10-10 22:53:22'),
(13, 406, '2024-10-10 22:53:22', '2024-10-10 22:53:22'),
(14, 403, '2024-10-10 22:53:22', '2024-10-10 22:53:22'),
(14, 405, '2024-10-10 22:53:22', '2024-10-10 22:53:22'),
(15, 404, '2024-10-10 22:53:22', '2024-10-10 22:53:22'),
(16, 404, '2024-10-10 22:53:22', '2024-10-10 22:53:22'),
(17, 400, '2024-10-10 22:53:22', '2024-10-10 22:53:22'),
(21, 406, '2024-10-10 22:53:22', '2024-10-10 22:53:22'),
(64, 405, '2024-10-10 22:53:22', '2024-10-10 22:53:22'),
(94, 400, '2024-10-10 22:53:22', '2024-10-10 22:53:22'),
(111, 350, '2024-03-25 20:52:19', '2024-03-25 20:52:19'),
(112, 350, '2024-03-25 20:52:19', '2024-03-25 20:52:19'),
(117, 368, '2024-10-09 21:01:28', '2024-10-09 21:01:28'),
(122, 368, '2024-10-09 21:01:28', '2024-10-09 21:01:28'),
(123, 349, '2024-03-25 20:52:19', '2024-03-25 20:52:19'),
(123, 372, '2024-10-09 22:18:31', '2024-10-09 22:18:31'),
...
(128, 403, '2024-10-10 22:53:22', '2024-10-10 22:53:22'),
(128, 405, '2024-10-10 22:53:22', '2024-10-10 22:53:22'),
...
(132, 368, '2024-10-09 21:01:28', '2024-10-09 21:01:28'),
(133, 400, '2024-10-10 22:53:22', '2024-10-10 22:53:22'),
(134, 404, '2024-10-10 22:53:22', '2024-10-10 22:53:22'),
(135, 405, '2024-10-10 22:53:22', '2024-10-10 22:53:22');

-- 
-- Dumping data for table resume_footers
--
INSERT INTO resume_footers VALUES
(187, 87, 'Jezici', 'Napredna razina engleskog jezika. Izvorni govornik ukrajinskog i ruskog jezika.\r\nSrednji nivo njemackog, poljskog.', 1, '2024-03-25 23:34:21', '2024-03-25 23:34:21'),
(188, 87, 'Tecajevi obuke', 'Oracle 11 DBA (database administrator), Informatica Power Center', 3, '2024-03-25 23:34:21', '2024-03-25 23:34:21'),
(209, 82, 'Technische Fahigkeiten und Technologie', '1', 1, '2024-10-09 21:01:28', '2024-10-09 21:01:28'),
(210, 82, 'Technische 2 Fahigkeiten und Technologie', '1', 2, '2024-10-09 21:01:28', '2024-10-09 21:01:28'),
(211, 82, 'Technische 3 Fahigkeiten und Technologie', '3', 3, '2024-10-09 21:01:28', '2024-10-09 21:01:28'),
(212, 82, 'Technische 4 Fahigkeiten und Technologie', '4', 4, '2024-10-09 21:01:28', '2024-10-09 21:01:28'),
(219, 86, 'Технічні навички та технології', 'DBA & Development для баз Microsoft SQL, Oracle - 10 років \r\nMS Azure – 3 роки \r\nSQL запроси - 10 років \r\nReports and dashboards – 5 років \r\nLinux Systems (Red hat & Ubuntu) - 6 років \r\nPHP – 3 роки \r\nPython – 1 рік', 1, '2024-10-09 22:18:31', '2024-10-09 22:18:31'),
(220, 86, 'Мови', 'Поглиблений рівень англійської мови. Носій української та російської мов. \r\nСередній рівень німецької, польської мов', 2, '2024-10-09 22:18:31', '2024-10-09 22:18:31'),
(221, 86, 'Курси навчання', 'Oracle 11 DBA (database administrator), Informatica Power Center', 3, '2024-10-09 22:18:31', '2024-10-09 22:18:31'),
(222, 86, 'Засоби зв’язку зі мною', 'Я часто буваю онлайн, і віддаю перевагу зустрічам з веб-камерою, живим спілкуванням.\r\nДуже прошу Вас надсилати запрошення електронною поштою. Для швидкого спілкування та коротких питань телефонуйте +38093 177 5176.', 4, '2024-10-09 22:18:31', '2024-10-09 22:18:31'),
(269, 85, 'Технічні навички та технології', 'Linux Systems (Red hat & Ubuntu) - 6 років\r\nMS Azure – 3 роки\r\nDevelopment for Oracle databases, Microsoft SQL server - 7 років\r\nSQL queries - 10 років\r\nReports and dashboards – 5 років\r\nPHP – 2 роки\r\nJava – 2 роки\r\nPython – 1 рік', 1, '2024-10-10 22:53:22', '2024-10-10 22:53:22'),
(270, 85, 'Мови', 'Поглиблений рівень англійської мови. Носій української та російської мов.', 2, '2024-10-10 22:53:22', '2024-10-10 22:53:22'),
(271, 85, 'Курси навчання', 'Oracle 11 DBA (database administrator), Informatica Power Center', 3, '2024-10-10 22:53:22', '2024-10-10 22:53:22'),
(272, 85, 'Засоби зв’язку зі мною', 'Я часто буваю онлайн, і віддаю перевагу зустрічам з веб-камерою, живим спілкуванням.\r\nДуже прошу Вас надсилати запрошення електронною поштою. Для швидкого спілкування та коротких питань телефонуйте +38093 177 5176.', 4, '2024-10-10 22:53:22', '2024-10-10 22:53:22');
