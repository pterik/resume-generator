...
type
  TFormNewTemplate = class(TForm)
    ...
    UniArchiveJobs2: TUniQuery;
    UniArchiveSkills2: TUniQuery;
    UniGetSkillList2: TUniQuery;
    UniGetSkillList2cntr: TLargeintField;
    UniGetSkillID2: TUniQuery;
    UniInsertSkill2: TUniQuery;
...
begin
  try
//  if not ArchiveJobs(FTemplateID) then
//    begin
//      FormMain.Warning('Ошибка при попытке архивирования Jobs');
//      Result := false;
//      exit;
//    end;
