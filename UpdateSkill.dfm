object FormUpdateSkill: TFormUpdateSkill
  Left = 0
  Top = 0
  Caption = #1056#1077#1076#1072#1075#1091#1074#1072#1085#1085#1103' '#1089#1082#1110#1083#1072
  ClientHeight = 158
  ClientWidth = 294
  Color = clBtnFace
  ...
  object CBCategory: TComboBox
    ...
    TabOrder = 3
    Text = 'CBCategory'
    OnExit = CBCategoryExit
  end
  object UniSkillCategory: TUniQuery
    ...
    object UniSkillCategorycreated: TDateTimeField
      FieldName = 'created'
    end
    object UniSkillCategoryupdated: TDateTimeField
      FieldName = 'updated'
    end
  end
  object UniDSSkillCategories: TUniDataSource
    DataSet = UniSkillCategory
    Left = 227
    Top = 8
  end
  object UniSPInsertSkill: TUniStoredProc
    ...
    SQL.Strings = (
        ...
        'CALL insert_skill(:p_skill, :p_category, @p_skill_id); SELECT CA' +
        'ST(@p_skill_id AS SIGNED) AS '#39'@p_skill_id'#39)
    Connection = FormMain.UniConnection
    Transaction = FormMain.UniTransaction
    Left = 216
    Top = 56
  ...
  object UniGetSkill: TUniQuery
    ...
    SQL.Strings = (
      ...
      'category_id, '
      '(select category from skills_categories sc'
      'where sc.id = s.category_id ) category,'
      's.created,'
      's.updated '
      'FROM skills s'
    ...
    object UniGetSkillcreated: TDateTimeField
      FieldName = 'created'
    end
    object UniGetSkillupdated: TDateTimeField
      FieldName = 'updated'
    end
  end
end
