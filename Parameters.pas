...
Edit_telephone_usa.Text:=FormMain.telephone_usa;
Edit_telephone_ukrainian.Text:=FormMain.telephone_ukrainian;
Edit_telephone_croatian.Text:=FormMain.telephone_croatian;
Edit_Telephone_english.Text:=FormMain.telephone_english;
EditEmail.Text:=FormMain.Email;
EditFullname.Text:=FormMain.FullName;
EditWebsite.Text:=FormMain.Website;
EditRecommend.Text:=FormMain.Recommendationlink;
EditEnglishTest.Text:=FormMain.EnglishTest;
Edit_main_folder_LAPTOP_PTERIK.Text:=FormMain.main_folder_LAPTOP_PTERIK;
Edit_main_folder_VESTA.Text:=FormMain.main_folder_VESTA;
end;
