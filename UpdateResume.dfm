object FormUpdateResume: TFormUpdateResume
  ...
  object PageControl: TPageControl
    ...
    object TabSheetFooter: TTabSheet
      ...
      object StaticText1: TStaticText
        ...
        Width = 79
        Height = 25
        Caption = #1053#1072#1074#1080#1095#1082#1080' 1'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -16
        Font.Name = 'Segoe UI'
    ...
    object TabSheetCL: TTabSheet
      ...
      object Label62: TLabel
        ...
        Height = 21
        Anchors = [akLeft, akBottom]
        Caption = #1047#1085#1072#1093#1086#1076#1078#1077#1085#1085#1103' '#1092#1072#1081#1083#1072' CL'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -16
        Font.Name = 'Segoe UI'
      ...
      object Label63: TLabel
        ...
        Anchors = [akLeft, akBottom]
        Caption = 
          #1064#1072#1073#1083#1086#1085' [/opportunity] '#1079#1084#1110#1085#1102#1108#1090#1100#1089#1103' '#1085#1072' '#1087#1086#1083#1077' "'#1053#1072#1079#1074#1072' '#1087#1086#1089#1072#1076#1080' ('#1087#1086#1074#1085#1110#1089#1090#1102 +
          ')"'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -16
      ...
      object EditCLDocFilepath: TEdit
        Left = 192
        Top = 407
        Width = 777
        Height = 29
    ...
    object TabSheetJob1: TTabSheet
      ...
      object RichEdit1Benefits: TRichEdit
        Left = 90
        Top = 444
        Width = 444
        Height = 90
    ...
    object TabSheetJob2: TTabSheet
      ...
      object RichEdit2Benefits: TRichEdit
        Left = 90
        Top = 435
        Width = 444
        Height = 90
    ...
    object TabSheetJob3: TTabSheet
      ...
      object RichEdit3Benefits: TRichEdit
        Left = 90
        Top = 434
        Width = 444
        Height = 90
    ...
    object TabSheetJob4: TTabSheet
      ...
      object RichEdit4Benefits: TRichEdit
        Left = 90
        Top = 434
        Width = 444
        Height = 90
    ...
    object TabSheetJob5: TTabSheet
      ...
      object RichEdit5Benefits: TRichEdit
        Left = 90
        Top = 435
        Width = 444
        Height = 90
    ...
    object TabSheetJob6: TTabSheet
      ...
      object RichEdit6Benefits: TRichEdit
        Left = 90
        Top = 434
        Width = 444
        Height = 90
    ...
    object TabSheetJob7: TTabSheet
      ...
      object RichEdit7Benefits: TRichEdit
        Left = 90
        Top = 434
        Width = 444
        Height = 90
    ...
    object TabSheetJob8: TTabSheet
      ...
      object RichEdit8Benefits: TRichEdit
        Left = 90
        Top = 434
        Width = 444
        Height = 90
    ...
    object TabSheetJob9: TTabSheet
      ...
      object RichEdit9Benefits: TRichEdit
        Left = 90
        Top = 434
        Width = 444
        Height = 90
    ...
    object TabSheetJob10: TTabSheet
      ...
      object RichEdit10Benefits: TRichEdit
        Left = 89
        Top = 434
        Width = 444
        Height = 90
  ...
  object UniResumeID: TUniQuery
    ...
    SQL.Strings = (
      'SELECT '
      '   id, name, lang, region_id, '
      
        '   (select region_name from regions r where id = region_id) regi' +
        'on,'
      '   job_opportunity, '
    ...
    object UniResumeIDlang: TWideStringField
      FieldName = 'lang'
      Size = 3
    end
    object UniResumeIDregion_id: TWideStringField
      FieldName = 'region_id'
      Size = 2
    end
    object UniResumeIDregion: TWideStringField
      FieldName = 'region'
      ReadOnly = True
      Size = 10
    end
    object UniResumeIDjob_opportunity: TWideStringField
      FieldName = 'job_opportunity'
      Required = True
      Size = 255
    end
    object UniResumeIDjob_place: TWideStringField
      FieldName = 'job_place'
      Size = 255
    end
    object UniResumeIDphone_numbers_text: TWideStringField
      FieldName = 'phone_numbers_text'
      Size = 255
    end
    object UniResumeIDresume_introduction: TWideMemoField
    ...
    object UniResumeIDcl_text: TWideMemoField
      FieldName = 'cl_text'
      BlobType = ftWideMemo
    end
    ...
    object UniResumeIDcl_doc_filepath: TWideStringField
  ...
  object UniFootersID: TUniQuery
    ...
    object UniFootersIDfooter_header: TWideStringField
      FieldName = 'footer_header'
      Size = 255
    end
    object UniFootersIDfooter_text: TWideMemoField
  ...
  object UniExperienceID: TUniQuery
    ...
    SQL.Strings = (
      ...
      '  template_id ,'
        ...
        '  row_number() over (partition by resume_id order by start_date ' +
        'desc) as job_order,'
      '  job_position ,'
      '  start_date ,'
      '  end_date ,'
    ...
    object UniExperienceIDjob_order: TLargeintField
      FieldName = 'job_order'
      ReadOnly = True
      Required = True
    end
    object UniExperienceIDjob_position: TWideStringField
    ...
    object UniExperienceIDemployer: TWideStringField
      FieldName = 'employer'
      Size = 255
    end
    object UniExperienceIDresponsibilities: TWideMemoField
      FieldName = 'responsibilities'
      BlobType = ftWideMemo
    end
    object UniExperienceIDbenefits: TWideMemoField
      FieldName = 'benefits'
      BlobType = ftWideMemo
    end
    object UniExperienceIDother: TWideMemoField
      FieldName = 'other'
      BlobType = ftWideMemo
    end
  ...
  object UniSPUpdateResume: TUniStoredProc
    ...
    SQL.Strings = (
        ...
        '_introduction, :p_cl_text, :p_archived, :p_footer_1_header, :p_f' +
        'ooter_1_text, :p_footer_2_header, :p_footer_2_text, :p_footer_3_' +
        'header, :p_footer_3_text, :p_footer_4_header, :p_footer_4_text, ' +
        ':p_cv_include_footer1, :p_cv_include_footer2, :p_cv_include_foot' +
        'er3, :p_cv_include_footer4, @p_result); SELECT CAST(@p_result AS' +
        ' SIGNED) AS '#39'@p_result'#39)
    Connection = FormMain.UniConnection
    Left = 192
    Top = 376
    ParamData = <
